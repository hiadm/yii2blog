...
class m180327_121053_alter_seo_table extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->addColumn(self::TABLE_NAME, 'followme', $this->text()->notNull()->defaultValue('')->comment('关注我'));
        ...
        $this->alterColumn(self::TABLE_NAME, 'fastchannel', $this->text()->notNull()->defaultValue('')->comment('快速通道'));
